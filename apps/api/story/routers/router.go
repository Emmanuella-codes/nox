...
func StoryRoutes(controller *controllers.StoryController, cfg *config.Config) []api.RouterSchema {
	...
	return []api.RouterSchema{
		...
		{RouteMethod: api.RouteMethod("GET"), Path: "/stories/:storyID/items/:itemID/viewers", Middlewares: auth, Handler: controller.ListStoryItemViewers},
		...
		{RouteMethod: api.RouteMethod("GET"), Path: "/personas/:personaID/highlight-stories", Middlewares: optionalAuth, Handler: controller.ListProfileStoryHighlights},
		...
		{RouteMethod: api.RouteMethod("POST"), Path: "/stories/:storyID/items/:itemID/views", Middlewares: auth, Handler: controller.ViewStoryItem},
		{RouteMethod: api.RouteMethod("POST"), Path: "/stories/:storyID/items/:itemID/reactions", Middlewares: auth, Handler: controller.ReactToStoryItem},
		{RouteMethod: api.RouteMethod("DELETE"), Path: "/stories/:storyID/items/:itemID/reactions", Middlewares: auth, Handler: controller.RemoveStoryItemReaction},
		{RouteMethod: api.RouteMethod("POST"), Path: "/stories/:storyID/items/:itemID/replies", Middlewares: auth, Handler: controller.ReplyToStoryItem},
		...
		{RouteMethod: api.RouteMethod("POST"), Path: "/stories/:storyID/profile-highlights", Middlewares: auth, Handler: controller.AddProfileStoryHighlight},
		{RouteMethod: api.RouteMethod("DELETE"), Path: "/stories/:storyID/profile-highlights", Middlewares: auth, Handler: controller.RemoveProfileStoryHighlight},
	}
}
