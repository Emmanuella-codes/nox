...
import (
	...
	"github.com/emmanuella-codes/nox/event/pipes"
...
type EventController struct {
	pipe *pipes.EventPipe
}

func NewEventController(pipe *pipes.EventPipe) *EventController {
	return &EventController{pipe: pipe}
}
...
func pipeErrorStatus(message shared.PipeMessage) int {
	...
	case messages.Event_Not_Found, messages.Persona_Not_Found:
