...
import (
	...
	"github.com/emmanuella-codes/nox/comment/pipes"
...
type CommentController struct {
	pipe *pipes.CommentPipe
}

func NewCommentController(pipe *pipes.CommentPipe) *CommentController {
	return &CommentController{pipe: pipe}
}
...
func pipeErrorStatus(message shared.PipeMessage) int {
	...
	case messages.Comment_Not_Found, messages.Post_Not_Found, messages.Persona_Not_Found:
